...
print(dirname)
file_to_load = os.path.join(dirname,"Resources","election_results.csv").replace("\\","/")
# Add a variable to save the file to a path.
file_to_save = os.path.join(dirname,"analysis","election_analysis.txt").replace("\\","/")
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (c_votes > highest_turnout_count) and (county_percentage > highest_county_percentage):
            highest_turnout_count = c_votes
